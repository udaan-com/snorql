...
You can also add your own metrics by following the instructions below under [Build your own custom metrics using snorql](https://udaan-com.github.io/snorql/sections/build-custom-metrics/).
